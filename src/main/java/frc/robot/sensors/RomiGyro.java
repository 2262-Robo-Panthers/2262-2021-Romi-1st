...
public class RomiGyro {
	...
	public double getRateX() {
		if (m_simRateX != null) return m_simRateX.get();
	...
	public double getRateY() {
		if (m_simRateY != null) return m_simRateY.get();
	...
	public double getRateZ() {
		if (m_simRateZ != null) return m_simRateZ.get();
	...
	public double getAngleX() {
		if (m_simAngleX != null) return m_simAngleX.get() - m_angleXOffset;
	...
	public double getAngleY() {
		if (m_simAngleY != null) return m_simAngleY.get() - m_angleYOffset;
	...
	public double getAngleZ() {
		if (m_simAngleZ != null) return m_simAngleZ.get() - m_angleZOffset;
